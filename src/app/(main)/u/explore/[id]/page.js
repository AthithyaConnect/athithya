    ...
    <div className="w-full max-w-sm min-h-screen pb-20 bg-neutral-100">
      ...
      <div className="relative h-[300px] w-full">
        ...
        <div className="absolute top-4 left-4">
          <button
            onClick={() => router.back()}
            className="p-3 text-white rounded-full shadow bg-black/50 backdrop-blur-sm"
          >
        ...
        <div className="flex flex-col gap-2 p-4 bg-white ">
          ...
          <div className="w-full">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110933.13520793748!2d77.96455110995264!3d30.31577428063274!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390929d07c0300a5%3A0xd3f30f743577e6e0!2sDecathlon%20Sports%20-%20Dehradun!5e1!3m2!1sen!2sin!4v1752658963253!5m2!1sen!2sin"
              style={{ border: 2, borderColor: "white" }}
              allowFullScreen=""
              loading="lazy"
