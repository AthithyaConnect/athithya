    ...
    <div className="flex items-center justify-center">
      <div className="w-full max-w-4xl ">
        <div className="flex flex-col p-2">
          <div className="items-center justify-between hidden mb-4 ">
      ...
      <div className="w-full overflow-hidden bg-white border border-gray-100 md:max-w-4xl rounded-2xl">
        <div className="relative">
          ...
          <div className="absolute top-0 w-full p-3 ">
            {/* for adding actinnn btns in images  */}
          </div>
...
const posts = [
  {
    id: 1,
    imageUrl:
      "https://media.cnn.com/api/v1/images/stellar/prod/220905135137-01-manas-bhatia-future-cities-ai.jpg?c=original",
    altText: "Mountain range at sunset",
  },
  {
    id: 2,
    imageUrl:
      "https://cdn.pixabay.com/photo/2023/01/09/18/24/ai-generated-7708031_960_720.jpg",
    altText: "City street at night",
  },
  {
    id: 3,
    imageUrl:
      "https://cdn.pixabay.com/photo/2024/05/29/04/32/ai-generated-8795168_1280.png",
    altText: "Person in a library",
  },
  {
    id: 4,
    imageUrl:
      "https://img.freepik.com/premium-photo/temple-mountain-with-tree-background_1153744-167073.jpg",
    altText: "Close-up of coffee beans",
  },
  {
    id: 5,
    imageUrl:
      "https://img.freepik.com/premium-photo/house-mountain-meadow-with-mountain-background_1109427-2436.jpg",
    altText: "Person walking on a forest trail",
  },
  {
    id: 6,
    imageUrl:
      "https://img.freepik.com/premium-photo/mountains-alps-with-clouds_1033579-136506.jpg",
